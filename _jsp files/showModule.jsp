...
<head> <title> All Modules</title></head>
	...
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="col-lg-3" align="center">
				<ul class="list-group">
					<c:forEach var="modu" items="${THE_MODS}">
		...
		<!--	<form action="orgChangeName" method="get">
					<input type="hidden" name="change" value="modPopulate"/>
					<input type="submit" class="btn btn-primary" value="Change The Module Name"/>
				</form>		
		 -->
		</div>
